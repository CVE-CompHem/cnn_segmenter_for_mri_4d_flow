...
# plot
R_values = [8, 20] # undersampling ratio
for subnum in [4, 5, 6, 7]: # subject number (change this for plotting patient results)
    ...
    for r in range(len(R_values)):
        ...
        predlabelpath = basepath + 'v' + str(subnum) + '_R' + str(R) + '_seg_cnn.h5'
        ...
        imageio.mimsave(basepath + 'v' + str(subnum) + '_R' + str(R) + '.gif', _gif, format='GIF', duration=0.25)